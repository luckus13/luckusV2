...
echo "\n";
echo "\e[94m            ~LUCKUS~               \n";
echo "\e[91m GA PAHAM TANYA GROUP COK\n";
echo "\e[93m GW JG BISA BKIN KAYAK GNI DOANK\n";
echo "\n";
echo "\e[96m[?] No Hp Boskuu (62/1) : ";
...
if ($register == false)
    ...
    if ($verif == false)
        ...
        echo "\e[93m[!] Trying to redeem Voucher : COBAGOFOOD2206 !\n";
        sleep(3);
        $claim = claim($verif);
        if ($claim == false)
            {
